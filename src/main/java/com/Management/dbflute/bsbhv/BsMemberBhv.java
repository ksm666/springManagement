...
public abstract class BsMemberBhv extends AbstractBehaviorWritable<Member, MemberCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<Member> selectByPK(Integer id) {
        return facadeSelectByPK(id);
    }

    protected OptionalEntity<Member> facadeSelectByPK(Integer id) {
        return doSelectOptionalByPK(id, typeOfSelectedEntity());
    }

    protected <ENTITY extends Member> ENTITY doSelectByPK(Integer id, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(id), tp);
    }

    protected <ENTITY extends Member> OptionalEntity<ENTITY> doSelectOptionalByPK(Integer id, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(id, tp), id);
    }

    protected MemberCB xprepareCBAsPK(Integer id) {
     ...
     */
    public List<Integer> extractIdList(List<Member> memberList)
    { return helpExtractListInternally(memberList, "id"); }
