...
public abstract class AbstractBsSampleCQ extends AbstractConditionQuery {
     ...
     */
    public void setPoint_Equal(Integer point) {
        doSetPoint_Equal(point);
    }

    protected void doSetPoint_Equal(Integer point) {
     ...
     */
    public void setPoint_NotEqual(Integer point) {
        doSetPoint_NotEqual(point);
    }

    protected void doSetPoint_NotEqual(Integer point) {
     ...
     */
    public void setPoint_GreaterThan(Integer point) {
     ...
     */
    public void setPoint_LessThan(Integer point) {
     ...
     */
    public void setPoint_GreaterEqual(Integer point) {
     ...
     */
    public void setPoint_LessEqual(Integer point) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setPoint_RangeOf(Integer minNumber, Integer maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setPoint_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     * @param rangeOfOption The option of range-of. (NotNull)
     */
    protected void setPoint_RangeOf(Integer minNumber, Integer maxNumber, RangeOfOption rangeOfOption) {
     ...
     */
    public void setPoint_InScope(Collection<Integer> pointList) {
        doSetPoint_InScope(pointList);
    }

    protected void doSetPoint_InScope(Collection<Integer> pointList) {
     ...
     */
    public void setPoint_NotInScope(Collection<Integer> pointList) {
        doSetPoint_NotInScope(pointList);
    }

    protected void doSetPoint_NotInScope(Collection<Integer> pointList) {
     ...
     * @param flag The value of flag as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setFlag_Equal(String flag) {
        doSetFlag_Equal(fRES(flag));
    }

    protected void doSetFlag_Equal(String flag) {
        regFlag(CK_EQ, flag);
    }
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * flag: {NotNull, varchar(64)}
     * @param flag The value of flag as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setFlag_NotEqual(String flag) {
        doSetFlag_NotEqual(fRES(flag));
    }

    protected void doSetFlag_NotEqual(String flag) {
        regFlag(CK_NES, flag);
    }
     ...
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * flag: {NotNull, varchar(64)}
     * @param flag The value of flag as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setFlag_GreaterThan(String flag) {
        regFlag(CK_GT, fRES(flag));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * flag: {NotNull, varchar(64)}
     * @param flag The value of flag as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setFlag_LessThan(String flag) {
        regFlag(CK_LT, fRES(flag));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * flag: {NotNull, varchar(64)}
     * @param flag The value of flag as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setFlag_GreaterEqual(String flag) {
        regFlag(CK_GE, fRES(flag));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * flag: {NotNull, varchar(64)}
     * @param flag The value of flag as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setFlag_LessEqual(String flag) {
        regFlag(CK_LE, fRES(flag));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * flag: {NotNull, varchar(64)}
     * @param flagList The collection of flag as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setFlag_InScope(Collection<String> flagList) {
        doSetFlag_InScope(flagList);
    }

    protected void doSetFlag_InScope(Collection<String> flagList) {
        regINS(CK_INS, cTL(flagList), xgetCValueFlag(), "flag");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * flag: {NotNull, varchar(64)}
     * @param flagList The collection of flag as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setFlag_NotInScope(Collection<String> flagList) {
        doSetFlag_NotInScope(flagList);
    }

    protected void doSetFlag_NotInScope(Collection<String> flagList) {
        regINS(CK_NINS, cTL(flagList), xgetCValueFlag(), "flag");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * flag: {NotNull, varchar(64)} <br>
     * <pre>e.g. setFlag_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param flag The value of flag as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setFlag_LikeSearch(String flag, ConditionOptionCall<LikeSearchOption> opLambda) {
        setFlag_LikeSearch(flag, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * flag: {NotNull, varchar(64)} <br>
     * <pre>e.g. setFlag_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param flag The value of flag as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setFlag_LikeSearch(String flag, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(flag), xgetCValueFlag(), "flag", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * flag: {NotNull, varchar(64)}
     * @param flag The value of flag as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setFlag_NotLikeSearch(String flag, ConditionOptionCall<LikeSearchOption> opLambda) {
        setFlag_NotLikeSearch(flag, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setFlag_NotLikeSearch(String flag, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(flag), xgetCValueFlag(), "flag", likeSearchOption);
    }

    protected void regFlag(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueFlag(), "flag"); }
    protected abstract ConditionValue xgetCValueFlag();
