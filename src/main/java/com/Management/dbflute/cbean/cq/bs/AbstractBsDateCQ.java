...
/**
 * The abstract condition-query of date.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsDateCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsDateCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * registName: {char(1)}
     * @param registname The value of registname as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setRegistname_Equal(String registname) {
        doSetRegistname_Equal(fRES(registname));
    }

    protected void doSetRegistname_Equal(String registname) {
        regRegistname(CK_EQ, registname);
    }

    /**
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * registName: {char(1)}
     * @param registname The value of registname as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setRegistname_NotEqual(String registname) {
        doSetRegistname_NotEqual(fRES(registname));
    }

    protected void doSetRegistname_NotEqual(String registname) {
        regRegistname(CK_NES, registname);
    }

    /**
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * registName: {char(1)}
     * @param registname The value of registname as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setRegistname_GreaterThan(String registname) {
        regRegistname(CK_GT, fRES(registname));
    }

    /**
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * registName: {char(1)}
     * @param registname The value of registname as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setRegistname_LessThan(String registname) {
        regRegistname(CK_LT, fRES(registname));
    }

    /**
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * registName: {char(1)}
     * @param registname The value of registname as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setRegistname_GreaterEqual(String registname) {
        regRegistname(CK_GE, fRES(registname));
    }

    /**
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * registName: {char(1)}
     * @param registname The value of registname as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setRegistname_LessEqual(String registname) {
        regRegistname(CK_LE, fRES(registname));
    }

    /**
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * registName: {char(1)}
     * @param registnameList The collection of registname as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setRegistname_InScope(Collection<String> registnameList) {
        doSetRegistname_InScope(registnameList);
    }

    protected void doSetRegistname_InScope(Collection<String> registnameList) {
        regINS(CK_INS, cTL(registnameList), xgetCValueRegistname(), "registName");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * registName: {char(1)}
     * @param registnameList The collection of registname as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setRegistname_NotInScope(Collection<String> registnameList) {
        doSetRegistname_NotInScope(registnameList);
    }

    protected void doSetRegistname_NotInScope(Collection<String> registnameList) {
        regINS(CK_NINS, cTL(registnameList), xgetCValueRegistname(), "registName");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * registName: {char(1)} <br>
     * <pre>e.g. setRegistname_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param registname The value of registname as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setRegistname_LikeSearch(String registname, ConditionOptionCall<LikeSearchOption> opLambda) {
        setRegistname_LikeSearch(registname, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * registName: {char(1)} <br>
     * <pre>e.g. setRegistname_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param registname The value of registname as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setRegistname_LikeSearch(String registname, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(registname), xgetCValueRegistname(), "registName", likeSearchOption);
    }
     ...
     * registName: {char(1)}
     * @param registname The value of registname as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setRegistname_NotLikeSearch(String registname, ConditionOptionCall<LikeSearchOption> opLambda) {
        setRegistname_NotLikeSearch(registname, xcLSOP(opLambda));
    }
     ...
     */
    protected void setRegistname_NotLikeSearch(String registname, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(registname), xgetCValueRegistname(), "registName", likeSearchOption);
    }
     ...
     * registName: {char(1)}
     */
    public void setRegistname_IsNull() { regRegistname(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * registName: {char(1)}
     */
    public void setRegistname_IsNotNull() { regRegistname(CK_ISNN, DOBJ); }

    protected void regRegistname(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueRegistname(), "registName"); }
    protected abstract ConditionValue xgetCValueRegistname();
     ...
     */
    public HpSLCFunction<DateCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, DateCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DateCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, DateCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DateCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, DateCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DateCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, DateCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DateCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, DateCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;DateCB&gt;() {
     *     public void query(DateCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<DateCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, DateCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        DateCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(DateCQ sq);

    protected DateCB xcreateScalarConditionCB() {
        DateCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected DateCB xcreateScalarConditionPartitionByCB() {
        DateCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<DateCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        DateCB cb = new DateCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "id";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(DateCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<DateCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(DateCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        DateCB cb = new DateCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "id";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(DateCQ sq);
     ...
     */
    public void myselfExists(SubQuery<DateCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        DateCB cb = new DateCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(DateCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected DateCB newMyCB() {
        return new DateCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return DateCQ.class.getName(); }
