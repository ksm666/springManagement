...
public class BsSampleCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public SampleCB acceptPK(Integer id) {
    ...
    public void union(UnionQuery<SampleCB> unionCBLambda) {
        final SampleCB cb = new SampleCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final SampleCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
    ...
    public void unionAll(UnionQuery<SampleCB> unionCBLambda) {
        final SampleCB cb = new SampleCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final SampleCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<SampleCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<SampleCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnFlag() { return doColumn("flag"); }
        ...
        @Override
        protected String getTableDbName() { return "sample"; }
        /**
        ...
        public HpSDRFunction<SampleCB, SampleCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<SampleCB> sq, SampleCQ cq, String al, DerivedReferrerOption op)
    ...
    protected String xgetConditionBeanClassNameInternally() { return SampleCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return SampleCQ.class.getName(); }
