package com.Management.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("Member", "com.Management.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("city", "com.Management.dbflute.bsentity.dbmeta.CityDbm");
        tmpMap.put("date", "com.Management.dbflute.bsentity.dbmeta.DateDbm");
        tmpMap.put("sample", "com.Management.dbflute.bsentity.dbmeta.SampleDbm");
